...
class Student:
    ...
    def to_dict(self) -> dict:
        """
        Serializa o objeto Aluno num dicionário.
        """
        return {
            "fio": self.fio,
    ...
    def from_dict(cls, d: dict):
        """
        Desserializa um dicionário num objeto Student.
        Utiliza cls() que chama __init__ e, posteriormente, __post_init__ para validação.
        """
        return cls(
    ...
    def __str__(self):
        """
        Retorna os dados da classe Student em formato string, compreensível para o utilizador.
        """
        return (
            f"Student: {self.fio}\n"
            f" Group: {self.group}\n"
...
if __name__ == "__main__":
    students_list = [
        ...
        Student("Pedro Manuel", "2007-11-30", "A-50", 4.0),
...
```
![01_greeting](../../images/lab08/Ex01.png)
![01_greeting](../../images/lab08/Ex02.png)
![01_greeting](../../images/lab08/Ex03.png)
